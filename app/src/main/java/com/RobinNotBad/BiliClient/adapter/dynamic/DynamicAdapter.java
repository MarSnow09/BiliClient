...
public class DynamicAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DynamicAdapter(Context context, List<Dynamic> dynamicList, RecyclerView recyclerView) {
        this(context, dynamicList, recyclerView, null);
    }

    public DynamicAdapter(Context context, List<Dynamic> dynamicList, RecyclerView recyclerView,
                          List<DynamicApi.UpInfo> recentUpList) {
    ...
    public int getItemViewType(int position) {
        ...
        return position == 1 && showRecentUp() ? 2 : 1;
    }
    ...
    public int getItemCount() {
        int size = dynamicList != null ? dynamicList.size() + 1 : 1;
        return showRecentUp() ? size + 1 : size;
    }
